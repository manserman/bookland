...
class AuteurController extends AbstractController
{
  ...
  /**
   * action 16 lister les auteurs ayant écrits dans au moins 3 livres
   * @Route("/action16", name="lister_auteur_ecrit_moins_trois_livres", methods={"GET","POST"})
   */
 public function auteurAyantEcrisAuMoinsTroisLivres(AuteurRepository $auteurRepository):Response{
  $repo = $this->getDoctrine()->getManager()->getRepository(Auteur::class);
  $auteurs = $repo->auteurAyantEcrisAuMoinsTroisLivres();
  return $this->render("/auteur/auteurMoinsTrois.html.twig", array("auteurs"=>$auteurs));
  }
}
